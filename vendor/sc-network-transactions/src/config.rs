...
/// Result of one outbound transaction gossip round.
#[derive(Clone, Debug)]
...
/// Orders outbound transaction gossip peers and caps fan-out.
...
/// Observes completed single-transaction propagation rounds.
