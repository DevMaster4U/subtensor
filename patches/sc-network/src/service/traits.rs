...
pub trait NetworkStatusProvider {
	...
	/// Connected peers' multiaddrs keyed by base58 peer id.
	async fn connected_peer_addresses(&self) -> HashMap<String, String>;
}
	...
	T: NetworkStatusProvider,
{
	...
	fn connected_peer_addresses<'life0, 'async_trait>(
		&'life0 self,
	...
	where
		...
		Self: 'async_trait,
	{
		T::connected_peer_addresses(self)
	}
}
